export default function Projects() {
  return (
    <section id="projects">
      <div className="wrap">
        <p className="eyebrow reveal">Featured projects</p>
        <h2 className="reveal">Built, hardened, deployed</h2>
        <p className="section-sub reveal">Not demos — platforms with users, auth, and uptime to protect.</p>
